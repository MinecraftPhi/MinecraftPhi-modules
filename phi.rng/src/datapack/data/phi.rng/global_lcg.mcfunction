...
scoreboard players operation $phi.rng.lcg.seed phiglobal *= $phi.rng.lcg.mul const
scoreboard players operation $phi.rng.lcg.seed phiglobal += $phi.rng.lcg.inc const
scoreboard players operation $phi.rng.value temp = $phi.rng.lcg.seed phiglobal
