...
execute store result score $phi.int64.high phitemp run data get block -30000000 0 1600 RecordItem.tag.phi.int64.value 0.00000000023283064365386962890625