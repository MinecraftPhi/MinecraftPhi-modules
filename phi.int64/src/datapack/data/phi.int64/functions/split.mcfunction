...
data modify entity ec-0-0-0-1 Color set from storage phi:int64 value
...
execute store result score $phi.int64.high phitemp run data get storage phi:int64 value 0.00000000023283064365386962890625