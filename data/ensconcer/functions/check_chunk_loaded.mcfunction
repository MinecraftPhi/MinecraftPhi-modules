...
kill @e[type=area_effect_cloud,tag=ensconcer.ld]
summon area_effect_cloud ~ ~ ~ {Tags:["ensconcer.ld"],Duration:100}
summon area_effect_cloud ~ ~ ~ {Tags:["ensconcer.ld"],Duration:100}
summon area_effect_cloud ~ ~ ~ {Tags:["ensconcer.ld"],Duration:100}
execute in the_nether run tp @e[type=area_effect_cloud,tag=ensconcer.ld,limit=1] ~ ~ ~
execute as @e[type=area_effect_cloud,tag=ensconcer.ld,x=0,limit=1] in the_end run tp @s ~ ~ ~
