...
execute store result block -30000000 0 1600 RecordItem.tag.ensconcer.whole_inventory[0].Slot byte 1 run scoreboard players remove $modifyinv.slot temp 100

# Move item into the armor section:
data modify block -30000000 0 1600 RecordItem.tag.ensconcer.armor append from block -30000000 0 1600 RecordItem.tag.ensconcer.whole_inventory[0]
